...
class SingleItemSandwich extends StatelessWidget {
  final String imagePath;

  SingleItemSandwich({Key? key, required this.imagePath}) : super(key: key);
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  ...
                  SizedBox(height: 10), // Reduced this value
                  Text(
                    'We proudly offer a mouthwatering Sandwich with cheese, onion, a refreshing cold drink, and crispy fries. Experience the delicious taste of our Sandwich with cheese, onion, cold drink, and fries. Savor the perfect Sandwich experience with our juicy patty, crispy lettuce, melted cheese, and a refreshing drink.',
                    style: TextStyle(
