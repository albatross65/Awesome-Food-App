...
class SingleItemPizza extends StatelessWidget {
  final String imagePath;

  SingleItemPizza({Key? key, required this.imagePath}) : super(key: key);
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  ...
                  SizedBox(height: 10), // Reduced this value
                  Text(
                    'We proudly offer a mouthwatering Pizza with cheese, onion, a refreshing cold drink, and crispy fries. Experience the delicious taste of our Pizza with cheese, onion, cold drink, and fries. Savor the perfect Pizza experience with our juicy patty, crispy lettuce, melted cheese, and a refreshing drink.',
                    style: TextStyle(
